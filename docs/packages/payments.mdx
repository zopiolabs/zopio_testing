---
title: Payments
description: How `zopio` handles payments and billing.
icon: 'credit-card'
---
...
zopio has a pre-built webhook handler for payment events. Read more about [inbound payment webhooks](/packages/webhooks/inbound#payment-events).
