...
<Info>To enable it, simply add a `NEXT_PUBLIC_GOOGLE_ANALYTICS_ID` environment variable to your project.</Info>
...
<Info>To enable it, simply add a `NEXT_PUBLIC_POSTHOG_KEY` environment variable to your project.</Info>
