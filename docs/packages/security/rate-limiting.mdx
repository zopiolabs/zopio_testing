...
You can then paste these environment variables each of the [environment variables](/setup/env) files.
...
<Note>For detailed information about these features and their implementation, refer to the [Upstash Ratelimit documentation](https://upstash.com/docs/redis/sdks/ratelimit-ts/overview).</Note>
